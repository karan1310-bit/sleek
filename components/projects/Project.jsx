...
export default function Project({index, title, setModal}) {
    ...
    return (
      ...
      >
        <h2 className="transform text-[30px] sm:text-[50px] lg:text-[60px] m-0 font-light font-variable transition-all duration-400 group-hover:-translate-x-[10px] lg:group-hover:-translate-x-[10px]">
          {title}
        </h2>
